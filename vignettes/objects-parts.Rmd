...
Another way forward is to decompose to tidy data and do the calculations yourself, this seems ok since centroid is really a simple one if you only want the "box centroid". 
